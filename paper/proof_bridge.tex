...
created.  Mention the Intermediate Value Theorem here: the continuous standing
readout changes sign, so an intervening crossing occurs.  In the source chart
that crossing is the midpoint $\pi/6$ in the $\pi/3$ chart;
...
(the sign flip is read with the Intermediate Value Theorem)
simultaneously;
\item prove, mentioning the Intermediate Value Theorem, that the source sign flip
forces the midpoint $\pi/6$ in the
...
threshold, the sign flips, and the next harmonic begins.  By the Intermediate
Value Theorem, that sign flip has an intervening crossing; the crossing occurs
...
Mention the Intermediate Value Theorem: the continuous standing readout must
pass through a crossing between the two signs.
...
constant.  At a source crossing, the standing readout changes sign.  Mention
the Intermediate Value Theorem: continuity gives an intervening zero crossing,
and the no-drift/unitary readout identifies that crossing with the midpoint of
the source chart.  The
...
(mention the Intermediate Value Theorem), new harmonic creation, and projection
...
\begin{proof}
At a crossing, the standing readout changes sign.  Mention the Intermediate
Value Theorem: since the standing readout is continuous through the crossing,
the sign change supplies an intervening zero of that readout.  The source
...
(Intermediate Value Theorem), and outgoing harmonic creation.
\end{proof}
...
node.  Mention the
Intermediate Value Theorem here only as the witness that the sign change gives
...
\begin{proof}
The constructed produced zeros are the explicit sequence
\[
  \operatorname{producedNTZ}(n)=\frac12+in .
\]
The native predicate $\operatorname{IsProducedHelixZero}(\rho)$ means precisely that
$\rho=\operatorname{producedNTZ}(n)$ for some $n$.  Therefore
\[
...
phasor ledger.  Its zero ledger is the vanishing set of the symmetric
closed-form pair, every ledger element has real part $1/2$, and a
count-indexed induction pushes that midpoint result through every measured
zero event.  This is the closed-form induction-to-infinity version of the
no-off-line conclusion.  Mention the Intermediate Value Theorem only for this
limited purpose: a sign change of the real standing wave witnesses an actual
zero between the signs.  The Intermediate Value Theorem does not force the
midpoint.  The midpoint is forced earlier by the source midline, no-drift
projection, and faithful readout.
